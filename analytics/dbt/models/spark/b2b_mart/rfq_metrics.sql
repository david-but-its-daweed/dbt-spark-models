...
SELECT DISTINCT
    ...
    ROW_NUMBER() OVER (PARTITION BY order_id ORDER by order_rfq_response_id, rfq_response_ts_msk) as order_rn,
    ROW_NUMBER() OVER (PARTITION BY order_id, rfq_request_id ORDER BY order_rfq_response_id, rfq_response_ts_msk) as rfq_rn,
