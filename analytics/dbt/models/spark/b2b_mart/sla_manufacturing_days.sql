...
orders_hist AS (
    SELECT
        ...
        MAX(IF(sub_status = 'client2BrokerPaymentSent', DATE_DIFF(lead_sub_status_ts,
            first_substatus_event_msk, DAY), NULL)) AS days_in_client_payment_sent,
        MAX(IF(sub_status = 'brokerPaymentReceived', DATE_DIFF(lead_sub_status_ts,
            first_substatus_event_msk, DAY), NULL)) AS days_in_broker_payment_received,
        MAX(IF(sub_status = 'broker2JoomSIAPaymentSent', DATE_DIFF(lead_sub_status_ts,
            first_substatus_event_msk, DAY), NULL)) AS days_in_joom_sia_payment_sent,
        MAX(IF(sub_status = 'joomSIAPaymentReceived', DATE_DIFF(lead_sub_status_ts,
            first_substatus_event_msk, DAY), NULL)) AS days_in_joom_sia_payment_recieved,
