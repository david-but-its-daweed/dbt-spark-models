...
(
    select distinct
        ...
        from_utc_timestamp(promocode.created as promocode_created_date, 'Europe/Berlin') as promocode_created_date_cet, 
        from_utc_timestamp(promocode.updated as promocode_updated_date, 'Europe/Berlin') as promocode_updated_date_cet,
    ...
    group by 
        ...
        from_utc_timestamp(promocode.created as promocode_created_date, 'Europe/Berlin'), 
        from_utc_timestamp(promocode.updated as promocode_updated_date, 'Europe/Berlin'),
        promocode.is_referral,
        promocode.discount_type,
        promocode.percent_discount_value,
        admin_user.email,
