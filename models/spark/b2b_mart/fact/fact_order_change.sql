...
SELECT a.event_id,
        ...
        a.status,
        a.sub_status,
        SUM(case when tag in ('grant', 'dapGrant') and stage = 'final' then -fee when stage = 'final' then fee end) AS total_final_price,
        ...
        SUM(case when tag in ('grant', 'dapGrant') and stage = 'confirmed' then -fee when stage = 'confirmed' then fee end) AS total_confirmed_price,
        SUM(case when tag in ('grant', 'dapGrant') and stage = 'confirmed'  then fee end) AS confirned_grant,
