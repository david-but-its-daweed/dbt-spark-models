...
SELECT
    ...
    CASE
        WHEN device.osType IN ('android', 'ios', 'tizen', 'harmonyos') THEN 'mobile'
        WHEN device.osType IN ('ubuntu', 'linux', 'mac os', 'windows', 'chromium os') THEN 'desktop'
        ELSE 'other'
