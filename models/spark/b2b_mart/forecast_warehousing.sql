{{ config(
    ...
    meta = {
      ...
      'bigquery_known_gaps': [
          '2023-07-10', '2023-09-16', '2023-09-15', '2023-10-18',
          '2023-11-16', '2023-11-29', '2023-11-30', '2023-12-01',
          '2023-12-02', '2024-04-15', '2024-05-21', '2024-05-14',
          '2024-07-18', '2025-07-23', '2025-07-25', '2025-07-26',
          '2025-07-24', '2025-07-21', '2025-07-22', '2025-07-27'
      ]
    }
) }}
